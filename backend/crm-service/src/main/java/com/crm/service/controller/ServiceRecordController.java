...
public class ServiceRecordController {
    ...
    @PreAuthorize("hasAuthority('" + Perms.SERVICE_RECORD_LIST + "')")
    @GetMapping("/page")
    ...
    @Log("新增售后记录")
    @PreAuthorize("hasAuthority('" + Perms.SERVICE_RECORD_ADD + "')")
    @PostMapping
    ...
    @PreAuthorize("hasAuthority('" + Perms.SERVICE_RECORD_EDIT + "')")
    @PutMapping
    ...
    @Log("删除售后记录")
    @PreAuthorize("hasAuthority('" + Perms.SERVICE_RECORD_DELETE + "')")
    @DeleteMapping("/{id}")
